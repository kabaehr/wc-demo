export class ReservationService {
	setReservations(seatsToReservate) {
		// for (let seat of seatsToReservate) {
		// 	const index = this.seats.indexOf(e => e._id === seat._id);
		// 	this.seats[index] = Object.assign({}, this.seats[index], { hasReservation: false });
		// }
	}
